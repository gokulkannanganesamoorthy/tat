...
const servicesData = [
  {
    ...
    desc: 'Free discovery about what your brand needs.',
    sub: [],
  },
  {
    id: '02',
    title: 'CAMPAIGN PLAN',
    desc: 'Comprehensive campaign planning across different platforms.',
    sub: [],
  },
  {
    id: '03',
    title: 'SOCIAL CONTENT',
    desc: 'Social media content creation.',
    sub: [],
  },
  {
    id: '04',
    title: 'SOCIAL MANAGEMENT',
    desc: 'End to end social media management.',
    sub: [],
  },
  {
    id: '05',
    title: 'EVENT CURATION',
    desc: 'Inhouse and outside event planning and execution tailored to your campaign.',
    sub: [],
  },
  {
    id: '06',
    title: 'PR & MEDIA',
    desc: 'Magazine, potential influencers, creators, and Radio.',
    sub: [],
  },
  {
    id: '07',
    title: 'COMMERCIAL FILMS',
    desc: 'High-quality Ad and commercial films for theatres.',
    sub: [],
  },
];
